          ...
          <Grid container spacing={2}>
            <Grid xs={12}>
              <Paper elevation={3} style={{ padding: "16px", position: "relative" }}>
                <div className="header" style={{ display: "flex", alignItems: "center", paddingTop: "10px" }}>
                  <button className="back-button" onClick={goBack} style={{ border: "none", background: "none", padding: 0 }}>
                    <i className="ni ni-bold-left" style={{ fontSize: "24px", color: "#343a40" }} />
                  </button>
                  <h5 className="mb-1" style={{ fontWeight: "bold", fontSize: "24px", color: "#343a40", marginLeft: "-15px", marginTop: "-5px" }}>
                    Trở lại
                  </h5>
